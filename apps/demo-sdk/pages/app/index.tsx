...
export default function AppPage({}) {
  ...
  useEffect(() => {
    ...
    if (process.env.NEXT_PUBLIC_FORMBRICKS_ENVIRONMENT_ID && process.env.NEXT_PUBLIC_FORMBRICKS_API_HOST) {
      ...
      const userId = isUserId ? "THIS-IS-A-VERY-LONG-USER-ID-FOR-TESTING-5" : undefined;
      anecdoteai.init({
    ...
    if (process.env.NEXT_PUBLIC_FORMBRICKS_ENVIRONMENT_ID && process.env.NEXT_PUBLIC_FORMBRICKS_API_HOST) {
      const handleRouteChange = anecdoteai?.registerRouteChange;
        ...
        <div className="md:grid md:grid-cols-3">
          ...
          <div className="p-6">
            <div>
              <button
                onClick={() => {
                  anecdoteai.setAttribute("Plan", "Free");
                }}
                className="mb-4 rounded-lg bg-slate-800 px-6 py-3 text-white hover:bg-slate-700  dark:bg-slate-700 dark:hover:bg-slate-600">
                Set Plan to &apos;Free&apos;
              </button>
          ...
          <div className="p-6">
            <div>
              <button
                onClick={() => {
                  anecdoteai.setAttribute("Plan", "Paid");
                }}
                className="mb-4 rounded-lg bg-slate-800 px-6 py-3 text-white hover:bg-slate-700  dark:bg-slate-700 dark:hover:bg-slate-600">
                Set Plan to &apos;Paid&apos;
              </button>
          ...
          <div className="p-6">
            <div>
              <button
                onClick={() => {
                  anecdoteai.setEmail("test@web.com");
                }}
                className="mb-4 rounded-lg bg-slate-800 px-6 py-3 text-white hover:bg-slate-700  dark:bg-slate-700 dark:hover:bg-slate-600">
                Set Email
              </button>
