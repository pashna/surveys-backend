...
export const env = createEnv({
  ...
  server: {
    ...
    SIGNUP_RATE_LIMIT_INTERVAL: z.string().min(1).optional(),
    SIGNUP_RATE_LIMIT_ALLOWED: z.string().min(1).optional(),
    LOGIN_RATE_LIMIT_INTERVAL: z.string().min(1).optional(),
    LOGIN_RATE_LIMIT_ALLOWED: z.string().min(1).optional(),
    CLIENT_RATE_LIMIT_INTERVAL: z.string().min(1).optional(),
    CLIENT_RATE_LIMIT_ALLOWED: z.string().min(1).optional(),
    SHARE_RATE_LIMIT_INTERVAL: z.string().min(1).optional(),
    SHARE_RATE_LIMIT_ALLOWED: z.string().min(1).optional(),
    SYNC_USER_IDENTIFICATION_RATE_LIMIT_INTERVAL: z.string().min(1).optional(),
    SYNC_USER_IDENTIFICATION_RATE_LIMIT_ALLOWED: z.string().min(1).optional(),
  },
  ...
  runtimeEnv: {
    ...
    SIGNUP_RATE_LIMIT_INTERVAL: process.env.SIGNUP_RATE_LIMIT_INTERVAL,
    SIGNUP_RATE_LIMIT_ALLOWED: process.env.SIGNUP_RATE_LIMIT_ALLOWED,
    LOGIN_RATE_LIMIT_INTERVAL: process.env.LOGIN_RATE_LIMIT_INTERVAL,
    LOGIN_RATE_LIMIT_ALLOWED: process.env.LOGIN_RATE_LIMIT_ALLOWED,
    CLIENT_RATE_LIMIT_INTERVAL: process.env.CLIENT_RATE_LIMIT_INTERVAL,
    CLIENT_RATE_LIMIT_ALLOWED: process.env.CLIENT_RATE_LIMIT_ALLOWED,
    SHARE_RATE_LIMIT_INTERVAL: process.env.SHARE_RATE_LIMIT_INTERVAL,
    SHARE_RATE_LIMIT_ALLOWED: process.env.SHARE_RATE_LIMIT_ALLOWED,
    SYNC_USER_IDENTIFICATION_RATE_LIMIT_INTERVAL: process.env.SYNC_USER_IDENTIFICATION_RATE_LIMIT_INTERVAL,
    SYNC_USER_IDENTIFICATION_RATE_LIMIT_ALLOWED: process.env.SYNC_USER_IDENTIFICATION_RATE_LIMIT_ALLOWED,
  },
});
